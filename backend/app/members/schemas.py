...
class MemberBase(BaseModel):
    ...
    stage: Optional[str] = Field(default="عام", description="المرحلة الخدمية/الدراسية")
    class_id: Optional[str] = Field(default=None, description="معرف الفصل للتسكين الفوري")
    group_name: Optional[str] = Field(default=None, description="اسم أسرة الخادم / الفصل / المجموعة")
    phone: Optional[str] = Field(default=None, description="رقم تليفون ولي الأمر الرئيسي")
